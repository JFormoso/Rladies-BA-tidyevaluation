...
**¿Qué es?**
Sintaxis para seleccionar columnas de un data frame, basándose en su nombre, posición o tipo. Es una extensión del data masking, pero con una semántica orientada a selección.

**¿Dónde se usa?**
En funciones como `select()`, `across()`, `pivot_longer()`, `pivot_wider()`, `separate()`, `extract()` y `unite()`.
